...
export default class WEbServerBuilder {
    ...
    #setupRoutes() {
        this.#server.use(this.#configuration.EXPRESS_CONFIGURATION.PRODUCTS_BASE_ROUTE, controllers.ProductController);
        this.#server.use(this.#configuration.EXPRESS_CONFIGURATION.CARTS_BASE_ROUTE, controllers.CartController);
        this.#server.use(this.#configuration.EXPRESS_CONFIGURATION.HANDLEBARS_BASE_ROUTE, controllers.HandlebarsController);
        this.#server.use(this.#configuration.EXPRESS_CONFIGURATION.USERS_BASE_ROUTE, controllers.UserController);
        this.#server.use(this.#configuration.EXPRESS_CONFIGURATION.OAUTH_BASE_ROUTE, controllers.OauthController);
    }
