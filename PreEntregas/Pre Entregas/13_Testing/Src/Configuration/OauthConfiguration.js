...
export default class OauthConfiguration {
    ...
    #getGithubClientID() {
        try {
            ...
            ConfigigurationManager.logger.info('OauthConfiguration - ClientID obtenido');
            return clientID;
        }
        catch (error) {
            throw error;
    ...
    #getGithubCLientSecret() {
        try {
            ...
            ConfigigurationManager.logger.info('OauthConfiguration - ClientSecret obtenido');
            return clientSecret;
        }
        catch (error) {
            throw error;
    ...
    #getGithubCallback() {
        try {
            ...
            ConfigigurationManager.logger.info('OauthConfiguration - callbackURL obtenido');
            return callbackUrl;
        }
        catch (error) {
            throw error;
