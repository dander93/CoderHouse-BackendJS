...
export const getCartByID = async (request, response, next) => {
...
export const postBuyCart = async (request, response, next) => {
    try {
...
export const postCreateCart = async (request, response, next) => {
    try {
        console.log("hola")
        response
...
export const postAddProductToCart = async (request, response, next) => {
    try {
...
export const deleteAllCartProducts = async (request, response, next) => {
    try {
        const { cid } = request.params;
...
export const updateProductsByCartID = async (request, response, next) => {
    try {
        const { cid } = request.params;
...
export const updateProductByCartID = async (request, response, next) => {
    try {
        const { cid, pid } = request.params;
