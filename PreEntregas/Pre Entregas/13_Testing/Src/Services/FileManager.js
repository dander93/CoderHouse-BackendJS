...
export default class FileManager {
    ...
    constructor(defaultEncoding) {
        ...
        // ConfigigurationManager.logger.info(`FileManager: Encoding configurado en: '${this.#defaultEncoding}'`);
    }
    ...
    async saveToFile(data, filePath) {
        try {
            ...
            if (!data) {
                ...
                ConfigigurationManager.logger.info(`Archivo '${filePath}' guardado`);
            }
    ...
    createFile(filePath, defaultContent) {
        try {
            ...
            ConfigigurationManager.logger.info(`FileManager: Archivo '${filePath}' creado correctamente`);
        }
        catch (error) {
    ...
    createPath(filePath) {
        try {
            ...
            ConfigigurationManager.logger.info(`FileManager: Path '${path}' creado correctamente`);
        }
        catch (error) {
