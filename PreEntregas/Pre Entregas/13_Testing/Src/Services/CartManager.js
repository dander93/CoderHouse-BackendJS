...
export default class CartManager {
    ...
    constructor() {
        try {
            ...
            if (!CartManager.#cartsRepository) {
                ...
                ConfigigurationManager.logger.info("CartManager: Configurando repositorio de carritos");
            }
        }
        catch (error) {
            throw error;
    ...
    async addProductToCart(cartID, productID) {
        try {
            ...
            if (!await CartManager.#cartsRepository.countDocuments({ _id: cartID })) {
                throw new BusinessException("El carrito no existe", "ERRCAR404", 404);
            }
